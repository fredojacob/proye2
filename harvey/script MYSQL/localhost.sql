...
--
-- Servidor: localhost
-- Tiempo de generación: 22-11-2017 a las 05:13:52
...
('def', 'login', 'datos', 'usuario', 1, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'login', 'datos', 'password', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'info', 'correo', 1, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'login', 'info', 'contrasena', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(25)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'logo', 'user', 1, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'logo', 'pass', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Nombre', 1, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Nombree', 2, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Apellidos', 3, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Nacimiento', 4, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Residencia', 5, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Ocupacion', 6, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Religion', 7, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Escolaridad', 8, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Etnia', 9, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Consulta', 10, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Personales', 11, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Quirurgico', 12, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Traumatico', 13, NULL, 'NO', 'varchar', 150, 150, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(150)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Alergico', 14, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Vicios', 15, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Manias', 16, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'nuevo', 'Familiar', 17, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'login', 'paciente', 'Nombre', 1, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'login', 'paciente', 'Segundonombre', 2, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'paciente', 'Apellidos', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'paciente', 'Sintomas', 4, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'login', 'paciente', 'Genero', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'paciente', 'Profesion', 6, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'paciente', 'Afiliasion', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(30)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'paciente', 'Fecha', 8, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'login', 'paciente', 'Medicamento', 9, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'login', 'paciente', 'nacimiento', 10, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'login', 'usuarios_pass', 'ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'login', 'usuarios_pass', 'USUARIOS', 2, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'login', 'usuarios_pass', 'PASSWORD', 3, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
...
('def', 'open_iso', 'nuevo', 'Codproceso', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'open_iso', 'nuevo', 'Edicion', 2, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'open_iso', 'nuevo', 'Fechaproceso', 3, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'open_iso', 'nuevo', 'Fecharevision', 4, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'open_iso', 'nuevo', 'Nombres', 5, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'open_iso', 'nuevo', 'Apellidos', 6, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'open_iso', 'nuevo', 'Observaciones', 7, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'open_iso', 'nuevo', 'Misionproceso', 8, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'open_iso', 'nuevo', 'Actividad', 9, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'open_iso', 'nuevo', 'Entrada', 10, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'open_iso', 'nuevo', 'Salida', 11, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'open_iso', 'nuevo', 'Procesorelacionado', 12, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
...
('HANDLER_READ_LAST', '1'),
('HANDLER_READ_NEXT', '231'),
('HANDLER_READ_PREV', '10'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '5136'),
('HANDLER_ROLLBACK', '9'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '4848'),
('INNODB_BUFFER_POOL_PAGES_DATA', '182'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '110'),
('INNODB_BUFFER_POOL_PAGES_FREE', '8009'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '2097'),
('INNODB_BUFFER_POOL_READS', '176'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '116'),
...
('INNODB_DATA_WRITES', '105'),
('INNODB_DATA_WRITTEN', '1830912'),
('INNODB_DBLWR_PAGES_WRITTEN', '55'),
('INNODB_DBLWR_WRITES', '12'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '24'),
('INNODB_LOG_WRITES', '24'),
('INNODB_OS_LOG_FSYNCS', '38'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '8776'),
('UPTIME_SINCE_FLUSH_STATUS', '8776');
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\Freddy.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\Freddy.log'),
('FLUSH_TIME', '1800'),
...
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\Freddy-slow.log'),
...
('def', 'login', 'PRIMARY', 'def', 'login', 'datos', 'usuario', 1, NULL, NULL, NULL, NULL),
('def', 'login', 'PRIMARY', 'def', 'login', 'info', 'correo', 1, NULL, NULL, NULL, NULL),
('def', 'login', 'PRIMARY', 'def', 'login', 'nuevo', 'Nombre', 1, NULL, NULL, NULL, NULL),
('def', 'login', 'PRIMARY', 'def', 'login', 'paciente', 'Nombre', 1, NULL, NULL, NULL, NULL),
('def', 'login', 'PRIMARY', 'def', 'login', 'usuarios_pass', 'ID', 1, NULL, NULL, NULL, NULL),
...
('def', 'open_iso', 'PRIMARY', 'def', 'open_iso', 'nuevo', 'Codproceso', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-11-22 05:13:54', '2017-11-22 05:13:54', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-11-22 05:13:54', '2017-11-22 05:13:54', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-11-22 05:13:54', '2017-11-22 05:13:54', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-11-22 05:13:54', '2017-11-22 05:13:54', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-11-22 05:13:54', '2017-11-22 05:13:54', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-11-22 05:13:54', '2017-11-22 05:13:54', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-11-22 05:13:54', '2017-11-22 05:13:54', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-11-22 05:13:54', '2017-11-22 05:13:54', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-11-22 05:13:54', '2017-11-22 05:13:54', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2017-11-22 05:13:54', NULL, NULL, NULL, '', '', NULL),
('def', 'login', 'datos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2017-11-08 00:28:36', NULL, NULL, NULL, '', '', NULL),
('def', 'login', 'info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 21, 780, 16384, NULL, 0, 0, '2017-11-08 00:28:37', NULL, NULL, NULL, '', '', NULL),
('def', 'login', 'logo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2017-11-08 00:28:37', NULL, NULL, NULL, '', '', NULL),
('def', 'login', 'nuevo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 0, 0, '2017-11-08 00:28:37', NULL, NULL, NULL, '', '', NULL),
('def', 'login', 'paciente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, 1092, 16384, NULL, 0, 0, '2017-11-08 00:28:37', NULL, NULL, NULL, '', '', NULL),
('def', 'login', 'usuarios_pass', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 19, 862, 16384, NULL, 0, 0, '2017-11-08 00:28:37', NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', '2012-04-19 13:45:10', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 465, 197, 91605, 55450570411999231, 16384, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1029, 9, 9261, 2533274790395903, 19456, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 875, 444876, 281474976710655, 20480, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2012-04-19 13:45:10', '2012-04-19 21:45:10', '2012-04-19 13:45:10', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 53, 212, 281474976710655, 2048, 0, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, NULL, '', '', NULL),
('def', 'open_iso', 'nuevo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11, 1489, 16384, NULL, 0, 0, '2017-11-21 05:37:01', NULL, NULL, NULL, '', '', NULL),
...
(154, 'root', 'localhost:53697', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'open_iso', 'latin1', 'latin1_swedish_ci', NULL),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '2244'),
('INNODB_BUFFER_POOL_READS', '176'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '116'),
('INNODB_DATA_FSYNCS', '62'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '8777'),
('UPTIME_SINCE_FLUSH_STATUS', '8777');
...
('def', 'login', 'datos', 0, 'login', 'PRIMARY', 1, 'usuario', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'login', 'info', 0, 'login', 'PRIMARY', 1, 'correo', 'A', 21, NULL, NULL, '', 'BTREE', '', ''),
('def', 'login', 'nuevo', 0, 'login', 'PRIMARY', 1, 'Nombre', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'login', 'paciente', 0, 'login', 'PRIMARY', 1, 'Nombre', 'A', 15, NULL, NULL, '', 'BTREE', '', ''),
('def', 'login', 'usuarios_pass', 0, 'login', 'PRIMARY', 1, 'ID', 'A', 19, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'open_iso', 'nuevo', 0, 'open_iso', 'PRIMARY', 1, 'Codproceso', 'A', 11, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-11-22 05:13:55', '2017-11-22 05:13:55', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-11-22 05:13:55', '2017-11-22 05:13:55', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-11-22 05:13:55', '2017-11-22 05:13:55', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-11-22 05:13:55', '2017-11-22 05:13:55', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-11-22 05:13:55', '2017-11-22 05:13:55', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-11-22 05:13:55', '2017-11-22 05:13:55', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-11-22 05:13:55', '2017-11-22 05:13:55', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-11-22 05:13:55', '2017-11-22 05:13:55', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-11-22 05:13:55', '2017-11-22 05:13:55', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2017-11-22 05:13:55', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'login', 'datos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 9437184, NULL, '2017-11-08 00:28:36', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'login', 'info', 'BASE TABLE', 'InnoDB', 10, 'Compact', 21, 780, 16384, 0, 0, 9437184, NULL, '2017-11-08 00:28:37', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'login', 'logo', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 9437184, NULL, '2017-11-08 00:28:37', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'login', 'nuevo', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 0, 9437184, NULL, '2017-11-08 00:28:37', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'login', 'paciente', 'BASE TABLE', 'InnoDB', 10, 'Compact', 15, 1092, 16384, 0, 0, 9437184, NULL, '2017-11-08 00:28:37', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'login', 'usuarios_pass', 'BASE TABLE', 'InnoDB', 10, 'Compact', 19, 862, 16384, 0, 0, 9437184, 20, '2017-11-08 00:28:37', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', '2012-04-19 13:45:10', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 465, 197, 91605, 55450570411999231, 16384, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1029, 9, 9261, 2533274790395903, 19456, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 875, 444876, 281474976710655, 20480, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2012-04-19 13:45:10', '2012-04-19 21:45:10', '2012-04-19 13:45:10', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 53, 212, 281474976710655, 2048, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 21:45:10', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
('def', 'open_iso', 'nuevo', 'BASE TABLE', 'InnoDB', 10, 'Compact', 11, 1489, 16384, 0, 0, 9437184, NULL, '2017-11-21 05:37:01', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
...
('def', 'login', 'PRIMARY', 'login', 'datos', 'PRIMARY KEY'),
('def', 'login', 'PRIMARY', 'login', 'info', 'PRIMARY KEY'),
('def', 'login', 'PRIMARY', 'login', 'nuevo', 'PRIMARY KEY'),
('def', 'login', 'PRIMARY', 'login', 'paciente', 'PRIMARY KEY'),
('def', 'login', 'PRIMARY', 'login', 'usuarios_pass', 'PRIMARY KEY'),
...
('def', 'open_iso', 'PRIMARY', 'open_iso', 'nuevo', 'PRIMARY KEY');
...
INSERT INTO `info` (`correo`, `contrasena`) VALUES
('bt@gmail.com', 963258),
('FGONZALEZ@GMAIL.COM', 789456123),
('freddy_2017@hotmail.com', 741258),
('fredo_y@hotmail.com', 74125),
('go@gmail.com', 56987),
('ja@gmail.com', 2564),
('jaa@gmail.com', 8964),
('jb@gmail.com', 45464),
('ji@gmail.com', 2654),
('ju@gmail.com', 86445),
('julia@gmail.com', 785412),
('ki@gmail.com', 56896),
('kimy95_hi@hotmail.com', 0),
('maria@gmail.com', 59221380),
('mariana@gmail.com', 78541236),
('Maria_ximena', 741236987),
('maricela@gmail.com', 0),
('pl@gmail.com', 852364),
('santi@gmail.com', 0),
('tu@gmail.com', 5687),
('zuly@gmail.com', 741258);
...
CREATE TABLE IF NOT EXISTS `nuevo` (
  ...
  `Quirurgico` text NOT NULL,
  `Traumatico` varchar(150) NOT NULL,
  `Alergico` text NOT NULL,
  `Vicios` varchar(20) NOT NULL,
  `Manias` varchar(20) NOT NULL,
...
INSERT INTO `nuevo` (`Nombre`, `Nombree`, `Apellidos`, `Nacimiento`, `Residencia`, `Ocupacion`, `Religion`, `Escolaridad`, `Etnia`, `Consulta`, `Personales`, `Quirurgico`, `Traumatico`, `Alergico`, `Vicios`, `Manias`, `Familiar`) VALUES
('', '', '', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '', ''),
('Andre', 'Gerardo', 'Reyes', '2017-08-24', 'pinula', 'Ingeniero', 'catolico', 'Universitario', 'indio', 'dolor de cabeza', 'ninguno', 'ninguno', 'ninguno', 'niguno', 'cigarro', 'alcoholico', 'niguno'),
('FIFA', 'nuevo', 'EASPORT', '2017-11-20', 'florida', 'ingeniero', 'catolico', 'bachillerato', 'ladino', 'dolor de cabeza', 'ninguno', 'ninguno', 'ninguno', 'ninguo', 'ninguno', 'ninguno', 'ninguo'),
('Freddy', 'Jacob', 'Morales', '1989-12-05', 'Guatemala', 'vago', 'catolico', 'Universitario', 'Ladino', 'dolor de cabeza', 'no', 'no', 'no', 'no', 'no', 'no', 'kajskjaksjkajksj'),
('Graciela', 'Maricela', 'Morales Giron', '1961-11-22', '13av 2-15', 'Maestra', 'catolico', 'Diversificado', 'Ladino', 'Dolor de hueso, dolor de cabeza', 'ninguno', 'ninguno', 'ninguno', 'niguno', 'cigarro', 'alcoholico', 'Su hermano es hipertenso'),
('Julio', 'jlia', 'skljlkajsl', '0054-04-06', 'sashjkah', 'hasjkhajkh', 'ASJHJAKHSJ', 'ASJHKJAHK', '`ASKHKJAH', 'AKJSHJAHJKA', 'AJSHKJAHS', 'AKJHKJASH', 'AKJSHAJKHS', 'AKSJHJAHSK', 'AKHSKJHASAS', 'AKSHKA', 'ASKJHKJAS'),
('Ximena', 'Isabel', 'Perez', '1990-11-02', 'el zapote', 'abogada', 'catolico', 'Universitario', 'Ladino', 'embarazo', 'ninguno', 'ninguno', 'ninguno', 'ninguno', 'ninguo', 'leer', 'ninguno');
...
INSERT INTO `paciente` (`Nombre`, `Segundonombre`, `Apellidos`, `Sintomas`, `Genero`, `Profesion`, `Afiliasion`, `Fecha`, `Medicamento`, `nacimiento`) VALUES
('diego', 'javier', 'lopez', 'dolor de cabeza', 0, 'veterinario', 84745896, '0000-00-00', 'panadol', '0000-00-00'),
('francisco', 'javier', 'duarte', 'dolor de estomago', 0, '', 0, '0000-00-00', '', '0000-00-00'),
('Freddy', 'Jacob', 'Gonzalez Morales', 'dolor de cabeza', 0, 'Ingeniero', 123741, '2017-08-14', 'dolor de cabeza', '2017-08-15'),
('Humberto', 'Freddy', 'Gonzalez Santisteban', 'diarrea, fiebre y dolor de cabeza', 0, 'Licenciado ', 852456, '0000-00-00', 'suero, penicilina', '0000-00-00'),
('Jacob', 'fredinho', 'Gonzalez Santisteban', 'dolor de dedo', 0, 'Ingeniero', 85245987, '0000-00-00', 'aspirina', '0000-00-00'),
('jhonnatan', 'julia', 'hernandez', 'dolor de cabeza', 0, 'mecanico', 852654, '0000-00-00', 'aspirina', '0000-00-00'),
('jose', 'rene', 'Gonzalez Santisteban', 'fiebre', 0, 'mecanico', 7456, '0000-00-00', 'penicilina', '0000-00-00'),
('karla', 'maria', 'vazquez', 'dolor de pierna', 0, 'estudiante', 789456, '0000-00-00', 'panadol', '0000-00-00'),
('kimberly', 'Maricela', 'Gonzalez Morales', 'Fiebre', 0, 'Doctora', 741852, '0000-00-00', 'penicilina', '0000-00-00'),
('kjalkjlk', 'aksjlkjalk', 'aslkjlkajlks', 'aklsjlkjalkj', 0, 'kjaslk', 0, '0000-00-00', 'ajklsjlkajlks', '0000-00-00'),
('maria', 'Ximena', 'trabanino', 'dolor de cabeza', 0, 'Abogada', 789655, '0000-00-00', 'panadol', '0000-00-00'),
('Mauricio', 'Antonio', 'Carias', 'dolor de pie', 0, 'Ingeniero', 7423696, '0000-00-00', 'aspirina', '0000-00-00'),
('meliza', 'andrea', 'aldana', 'dolor de cabeza', 0, 'Abogada', 745858, '0000-00-00', 'panadol', '0000-00-00'),
('Pamela', 'pamelovsky', 'gomez', 'dolor de estomago', 0, 'edecan', 8547854, '0000-00-00', 'penicilina', '0000-00-00'),
('Zayda', 'alejandra', 'Trabanino', 'dolor de dedo', 0, 'Ingeniero', 963258, '0000-00-00', 'aspirina', '0000-00-00');
...
(8, 'george', '123456'),
(9, 'francisco', '123456'),
(10, 'juancarlos', '123456'),
(11, 'juancarloss', '123456'),
(12, 'juancarlosss', '123456'),
(13, 'arturo', '123456'),
(14, 'harvey', '123456789'),
(15, 'artista', '123456789'),
(16, 'dpf', '789456'),
(17, 'dpff', '123456'),
(18, 'maricela', '123456'),
(19, 'SergioSilencio', '123456');
--
-- Base de datos: `mysql`
--
...
--
-- Base de datos: `open_iso`
--
CREATE DATABASE `open_iso` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `open_iso`;
...
CREATE TABLE IF NOT EXISTS `nuevo` (
  ...
  `Misionproceso` text NOT NULL,
  `Actividad` text NOT NULL,
  `Entrada` text NOT NULL,
  `Salida` text NOT NULL,
  `Procesorelacionado` text NOT NULL,
...
INSERT INTO `nuevo` (`Codproceso`, `Edicion`, `Fechaproceso`, `Fecharevision`, `Nombres`, `Apellidos`, `Observaciones`, `Misionproceso`, `Actividad`, `Entrada`, `Salida`, `Procesorelacionado`) VALUES
(0, '', '0000-00-00', '0000-00-00', '', '', '', '', '', '', '', ''),
(27, 'nueeevo', '2017-11-21', '0000-00-00', '', '', 'alsklaklsakl', 'salklasklsaklas', 'alsklaklkas', '2017-11-21', '', 'alsklasklkaslsa'),
(28, 'bee', '2017-11-21', '0000-00-00', 'gonzalez', 'nuevo', 'nuevo', ' nuevo', ' nuevo', '2017-11-21', '', ' nuevo'),
(40, 'beeeee', '2012-11-21', '0000-00-00', 'fgGONZALE', 'NUEO', 'NUEO', 'NUEO', ' NUEO', '2101-11-21', '', 'NUEO'),
(69, 'gay', '2017-11-21', '0000-00-00', 'gay', 'gay', 'gay', 'gay', 'gay', '2017-11-21', 'gay', 'gay'),
(85, 'bee', '2017-11-21', '0000-00-00', 'bee', 'bee', 'bee', 'bee', 'bee', '2017-11-21', 'bee', 'bee'),
(95, 'bee', '2017-11-21', '0000-00-00', 'gonz', 'nuevo', 'nuevo ', 'nuevo ', 'nuevo', '2017-11-21', 'nuevo', 'nuevo'),
(96, 'bee', '2017-11-21', '0000-00-00', 'bee', 'bee', 'bee', 'bee', 'bee', '2017-11-21', 'bee', 'bee'),
(98, 'bee', '2017-11-21', '0000-00-00', 'morales', 'nuevo', ' nuevo', ' nuevo ', 'nuevo ', '2017-11-21', '', 'nueo'),
(101, 'nuevo', '2017-11-21', '0000-00-00', 'ANDRR', 'ANDRE', 'NDRE', 'ANDRE', 'ANDRE', '2017-11-21', 'ANDRE', 'ANDRE'),
(555, 'FEE', '0000-00-00', '0000-00-00', 'feee', 'gonza', 'gonza', 'gonza', 'gonza', '2017-11-21', 'gonza', 'gonza');
--
